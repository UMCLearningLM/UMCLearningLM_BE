...
import com.umc.learninglm.domain.storage.service.StorageService;
...
public class StorageController {
	...
	@ApiResponses({
			...
			@ApiResponse(responseCode = "404", description = "AUTH40401: 사용자를 찾을 수 없음"),
	...
	public BaseResponse<StorageTutorialListResponse> getSavedTutorials() {
		return BaseResponse.success(storageService.getSavedTutorials());
	}
	...
	public BaseResponse<StorageFlowListResponse> getMyFlows(
		...
		return BaseResponse.success(storageService.getMyFlows(type));
	}
}
