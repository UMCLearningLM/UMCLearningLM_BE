...
import com.umc.learninglm.domain.block.service.BlockService;
...
public class BlockController {
    ...
    @Operation(
            ...
            description = """
                    ...
                    tutorialId가 있으면 해당 공식 튜토리얼에서 배치 가능한 블록과 필수 여부를 반환합니다.
                    """
    )
    @ApiResponses({
            @ApiResponse(
    ...
    public BaseResponse<BlockListResponse> getBlocks(
        ...
        return BaseResponse.success(
                blockService.getBlocks(q, stage, tutorialId)
        );
    }
}